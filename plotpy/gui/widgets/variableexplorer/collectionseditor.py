...
from plotpy.core.utils.path import getcwd_or_home
...
from plotpy.gui.widgets.qthelpers import mimedata2url
from plotpy.gui.widgets.variableexplorer.importwizard import ImportWizard
...
def get_test_data():
    ...
    try:
        ...
        test_dtindex = pd.DatetimeIndex(
            start="1939-09-01T", end="1939-10-06", freq="12H"
        )
