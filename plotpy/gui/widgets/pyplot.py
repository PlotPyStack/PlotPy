...
``import matplotlib.pyplot`` by ``import plotpy.gui.widgets.pyplot`` should suffice, as
shown in the following example:
    ...
    * Switching from `matplotlib` to `plotpy` is trivial::
        ...
        import plotpy.gui.widgets.pyplot as plt # only this line has changed!
        import numpy as np
        x = np.linspace(-10, 10)
        plt.plot(x, x**2, 'r+')
        plt.show()
...
from plotpy.gui.widgets.cross_section import XCrossSection, YCrossSection
...
from plotpy.gui.widgets.items.image import INTERP_AA, INTERP_LINEAR, INTERP_NEAREST
