...
from plotpy.gui.widgets.baseplot import BasePlot
from plotpy.gui.widgets.config import CONF, _, make_title
from plotpy.gui.widgets.histogram import HistogramItem, lut_range_threshold
from plotpy.gui.widgets.items.annotations import (
    AnnotatedEllipse,
    AnnotatedRectangle,
    AnnotatedSegment,
)
from plotpy.gui.widgets.items.curve import CurveItem, ErrorBarCurveItem, GridItem
...
from plotpy.gui.widgets.items.label import (
    DataInfoLabel,
    LabelItem,
    LegendBoxItem,
    RangeComputation,
...
class PlotItemBuilder(object):
    ...
    def quadgrid(
        ...
        self.__set_image_param(
            param, title, alpha_mask, alpha, interpolation, colormap=colormap, lock_position=lock_position
        )
