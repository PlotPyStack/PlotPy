...
from plotpy.console.widgets.mixins import (
    BrowseHistoryMixin,
    GetHelpMixin,
    SaveHistoryMixin,
    TracebackLinksMixin,
)
from plotpy.console.widgets.sourcecode.base import ConsoleBaseWidget
from plotpy.core.utils.path import get_conf_path
...
from plotpy.gui.widgets.dialog import get_save_filename
...
class PythonShellWidget(TracebackLinksMixin, ShellBaseWidget, GetHelpMixin):
    ...
    def setup_context_menu(self):
        ...
        clear_line_action = create_action(
            self,
            _("Clear line"),
            shortcut=QKeySequence(get_shortcut("console", "Clear line")),
            icon=get_icon("editdelete.png"),
            tip=_("Clear line"),
        ...
        clear_action = create_action(
            self,
            _("Clear shell"),
            shortcut=QKeySequence(get_shortcut("console", "Clear shell")),
