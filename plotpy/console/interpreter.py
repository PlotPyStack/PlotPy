...
from plotpy.console.dochelpers import isdefined
from plotpy.core.utils import program
from plotpy.core.utils.path import getcwd_or_home, remove_backslashes
...
"""
    ...
    def run_command(self, cmd, new_prompt=True):
        ...
        # Execute command
            ...
            # System ! command
            pipe = program.run_shell_command(cmd[1:])
