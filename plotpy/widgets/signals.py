...
Signals available:
    ...
    :py:attr:`.histogram.LevelsHistogram.SIG_VOI_CHANGED`
        ...
        changed (for now, this signal is for plotpy.gui.widgets.histogram module's
