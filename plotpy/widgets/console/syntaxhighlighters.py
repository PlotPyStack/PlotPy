...
# ==============================================================================
class BaseSH(QG.QSyntaxHighlighter):
    ...
    def get_background_color(self):
        ...
        :return:
        """
        return QG.QColor(self.background_color)
    ...
    def get_currentline_color(self):
        ...
        :return:
        """
        return QG.QColor(self.currentline_color)
    ...
    def get_currentcell_color(self):
        ...
        :return:
        """
        return QG.QColor(self.currentcell_color)
    ...
    def get_occurrence_color(self):
        ...
        :return:
        """
        return QG.QColor(self.occurrence_color)
    ...
    def get_ctrlclick_color(self):
        ...
        :return:
        """
        return QG.QColor(self.ctrlclick_color)
    ...
    def get_sideareas_color(self):
        ...
        :return:
        """
        return QG.QColor(self.sideareas_color)
    ...
    def get_matched_p_color(self):
        ...
        :return:
        """
        return QG.QColor(self.matched_p_color)
    ...
    def get_unmatched_p_color(self):
        ...
        :return:
        """
        return QG.QColor(self.unmatched_p_color)
    ...
    def setup_formats(self, font=None):
        ...
        :param font:
        """
        base_format = QG.QTextCharFormat()
        if font is not None:
            self.font = font
        ...
        for name, (color, bold, italic) in list(colors.items()):
            format = QG.QTextCharFormat(base_format)
            format.setForeground(QG.QColor(color))
            format.setBackground(QG.QColor(self.background_color))
            if bold:
                format.setFontWeight(QG.QFont.Bold)
    ...
    def highlight_spaces(self, text, offset=0):
        ...
        show_blanks = flags_text & QG.QTextOption.ShowTabsAndSpaces
        if show_blanks:
    ...
    def rehighlight(self):
        ...
        QG.QSyntaxHighlighter.rehighlight(self)
