...
from plotpy.widgets.panels import ID_OCS, ID_XCS, ID_YCS
from plotpy.widgets.tools.base import PanelTool
from plotpy.widgets.tools.shapes import RectangularShapeTool
