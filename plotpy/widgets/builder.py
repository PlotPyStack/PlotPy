...
from plotpy.widgets.styles.histogram import Histogram2DParam, HistogramParam
...
from plotpy.widgets.styles.label import LabelParam, LabelParamWithContents, LegendParam
from plotpy.widgets.styles.shape import AnnotationParam, MarkerParam
