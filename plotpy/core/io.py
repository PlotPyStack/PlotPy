...
register_serializable_items(
    "plotpy.core.items.curve.base",
    ["CurveItem"],
)
register_serializable_items(
    "plotpy.core.items.polygon",
    ["PolygonMapItem"],
)
register_serializable_items(
    "plotpy.core.items.curve.errorbar",
    ["ErrorBarCurveItem"],
)
# Images
register_serializable_items(
    "plotpy.core.items.image.base",
    ["RawImageItem"],
)
register_serializable_items(
    "plotpy.core.items.image.image_items",
    ["ImageItem", "XYImageItem", "RGBImageItem"],
)
register_serializable_items(
    "plotpy.core.items.image.transform",
    ["TrImageItem"],
)
register_serializable_items(
    "plotpy.core.items.image.masked",
