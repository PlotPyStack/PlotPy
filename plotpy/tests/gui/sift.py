...
def normalize(yin, parameter="maximum"):
    ...
    if parameter == "maximum":
        ...
        raise RuntimeError("Unsupported parameter {}".format(parameter))
...
class ImageParamNew(DataSetGui):
    ...
    type = ChoiceItem(
        _("Type"), (("zeros", _("zeros")), ("empty", _("empty")), ("rand", _("random")))
    )
...
class ObjectFT(QSplitter):
    ...
    def refresh_list(self, new_current_row="current"):
        ...
        self.listwidget.addItems(
            [
                "{}{:03d}: {}".format(self.PREFIX, i, obj.title)
    ...
    def compute_sum(self):
        ...
        sumobj.title = "+".join(["{}{:03d}".format(self.PREFIX, row) for row in rows])
        try:
            for row in rows:
                obj = self.objects[row]
    ...
    def compute_average(self):
        rows = self._get_selected_rows()
        sumobj = self.PARAMCLASS()
        title = ", ".join(["{}{:03d}".format(self.PREFIX, row) for row in rows])
        sumobj.title = _("Average") + ("({})".format(title))
    ...
    def compute_difference(self):
        ...
        diffobj.title = "-".join(["{}{:03d}".format(self.PREFIX, row) for row in rows])
        try:
    ...
    def compute_11(
        ...
        for row in rows:
            ...
            obj = self.PARAMCLASS()
            obj.title = "{}({}{:03d})".format(name, self.PREFIX, row)
...
class SignalFT(ObjectFT):
    ...
    def extract_roi(self):
        ...
        self.compute_11(
            ...
            param,
            suffix=lambda p: "rows={}:".format(p.row1, p.row2),
        )
    ...
    def normalize(self):
        ...
        self.compute_11(
            "Normalize", func, param, suffix=lambda p: "ref={}".format(p.method)
        )
    ...
    def calibrate(self):
        ...
        self.compute_11(
            ...
            func,
            param,
            suffix=lambda p: "{}={}*{}+{}".format(p.axis, p.a, p.axis, p.b),
        )
    ...
    def new_signal(self):
        ...
        signalnew.title = "{} {}".format(signalnew.title, self.number + 1)
...
class ImageFT(ObjectFT):
    ...
    def rotate_arbitrarily(self):
        ...
        self.compute_11(
            ...
            param,
            suffix=lambda p: "α={:0.3f}°, mode='{}'".format(p.angle, p.mode),
        )
    ...
    def extract_roi(self):
        ...
        self.compute_11(
            ...
            param,
            suffix=lambda p: "rows={}:{},cols={}:{}".format(
    ...
    def flat_field_correction(self):
        ...
        robj.title = (
            "FlatField("
            + (",".join(["{}{:03d}".format(self.PREFIX, row) for row in rows]))
            + ")"
        )
        try:
            robj.data = flatfield(
    ...
    def calibrate(self):
        ...
        self.compute_11(
            ...
            param,
            suffix=lambda p: "z={}*z+{}".format(p.a, p.b),
        )
    ...
    def compute_threshold(self):
        ...
        self.compute_11(
            ...
            suffix=lambda p: "min={} lsb".format(p.value),
        )
    ...
    def compute_clip(self):
        ...
        self.compute_11(
            ...
            suffix=lambda p: "max={} lsb".format(p.value),
        )
    ...
    def new_image(self):
        ...
        imagenew.title = "{} {}".format(imagenew.title, self.number + 1)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        status.showMessage(_("Welcome to {}!").format(APP_NAME), 5000)
        ...
        self.curvewidget = DockablePlotWidget(
            self, PlotWidget, curveplot_toolbar, options={"type": PlotType.CURVE}
        )
        ...
        self.imagewidget = DockablePlotWidget(
            self, PlotWidget, imagevis_toolbar, options={"type": PlotType.IMAGE}
        )
        ...
        # Eventually add an internal console
