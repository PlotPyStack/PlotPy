...
def test_edit_mutable_and_immutable_types(monkeypatch):
    ...
    editor_list.delegate.createEditor(None, None, editor_list.model.createIndex(1, 3))
    ...
    # List inside list
    editor_list.delegate.createEditor(None, None, editor_list.model.createIndex(3, 3))
    ...
    # Tuple inside list
    editor_list.delegate.createEditor(None, None, editor_list.model.createIndex(4, 3))
    ...
    editor_tup.delegate.createEditor(None, None, editor_tup.model.createIndex(1, 3))
    ...
    # List inside tuple
    editor_tup.delegate.createEditor(None, None, editor_tup.model.createIndex(3, 3))
    assert mockCollectionsEditor_instance.show.call_count == 3
    assert mockCollectionsEditor_instance.setup.call_args[1]["readonly"]

    # Tuple inside tuple
    editor_tup.delegate.createEditor(None, None, editor_tup.model.createIndex(4, 3))
...
def test_editor_parent_set(monkeypatch):
    ...
    for idx, mock_class in enumerate(
        ...
        col_editor.delegate.createEditor(
            col_editor.parent(), None, col_editor.model.createIndex(idx, 3)
        )
